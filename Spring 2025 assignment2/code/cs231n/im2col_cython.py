...
def im2col_cython(x, field_height,
...
def col2im_6d_cython_inner(cols,
                            x_padded,
                            N, C, H, W, HH, WW,
...
def col2im_6d_cython(cols, N, C, H, W,
        HH, WW, pad, stride):
    x = np.empty((N, C, H, W), dtype=cols.dtype)
